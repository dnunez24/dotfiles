...
set fish_user_paths "$HOME/.bin" "./vendor/bin" "./node_modules/.bin" "/usr/local/sbin" "$HOME/.composer/vendor/bin" "$HOME/.platformsh/bin/" "$HOME/.magento-cloud/bin/" "$HOME/.cargo/bin"
